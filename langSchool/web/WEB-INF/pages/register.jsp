...
<div class="container">
    <c:url value="/registration" var="registr"/>
    <form:form method="POST" action="${registr}" modelAttribute="newCustomer" class="form-signin">
        ...
        <spring:bind path="numberPhone">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="text" path="numberPhone" class="form-control" placeholder="numberPhone"
                            autofocus="true"></form:input>
                <form:errors path="numberPhone"></form:errors>
            </div>
        </spring:bind>
        ...
        <spring:bind path="pass">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="pass" path="pass" class="form-control" placeholder="pass"></form:input>
